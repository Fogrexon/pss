...
import { RequiredStyle } from "./StyleTypes";
import { Align, Direction, Display, FlexDirection, Justify, PositionType, Wrap, Node as YogaNode } from "yoga-layout";
 ...
 */
export const rootStyle: RequiredStyle = {
    // Layout
    display: 'flex',
 ...
 */
export const defaultStyles: RequiredStyle = {
    // Layout
    display: 'flex',
    flexDirection: 'column',
    justifyContent: 'flex-start',
...
export const defaultMiddleStyle: MiddleStyle = {
    // MiddleLayoutStyles
    width: 0,
    height: 0,
    minWidth: 0,
